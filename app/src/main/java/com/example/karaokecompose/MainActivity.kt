        ...
        setContent {
            MyTheme {
                ...
                NavHost(navController = navController, startDestination = "MainMenu"){
                    ...
                    composable("EditSongLyric/{artistName}/{songName}/{songLyrics}") { backStackEntry ->
                        SongLyricEditScreen.create(navController, backStackEntry, applicationContext, id, lifecycleScope, viewModel)
                    }
                }
            }
        }
